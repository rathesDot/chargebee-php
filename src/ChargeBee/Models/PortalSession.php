...
class ChargeBee_PortalSession extends ChargeBee_Model
{
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::GET, ChargeBee_Util::encodeURIPath('portal_sessions', $id), [], $env, $headers);
    }

    public static function logout($id, $env = null, $headers = [])
    {
        return ChargeBee_Request::send(ChargeBee_Request::POST, ChargeBee_Util::encodeURIPath('portal_sessions', $id, 'logout'), [], $env, $headers);
    }
