...
class ChargeBee_Invoice extends ChargeBee_Model
{
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::POST, ChargeBee_Util::encodeURIPath('invoices', $id, 'stop_dunning'), [], $env, $headers);
    }
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::GET, ChargeBee_Util::encodeURIPath('invoices', $id), [], $env, $headers);
    }
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::POST, ChargeBee_Util::encodeURIPath('invoices', $id, 'close'), [], $env, $headers);
    }
