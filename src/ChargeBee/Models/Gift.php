...
class ChargeBee_Gift extends ChargeBee_Model
{
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::GET, ChargeBee_Util::encodeURIPath('gifts', $id), [], $env, $headers);
    }
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::POST, ChargeBee_Util::encodeURIPath('gifts', $id, 'claim'), [], $env, $headers);
    }

    public static function cancel($id, $env = null, $headers = [])
    {
        return ChargeBee_Request::send(ChargeBee_Request::POST, ChargeBee_Util::encodeURIPath('gifts', $id, 'cancel'), [], $env, $headers);
    }
}
