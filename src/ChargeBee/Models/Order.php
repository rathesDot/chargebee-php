...
class ChargeBee_Order extends ChargeBee_Model
{
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::POST, ChargeBee_Util::encodeURIPath('orders', $id, 'assign_order_number'), [], $env, $headers);
    }
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::GET, ChargeBee_Util::encodeURIPath('orders', $id), [], $env, $headers);
    }
