...
class ChargeBee_Coupon extends ChargeBee_Model
{
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::GET, ChargeBee_Util::encodeURIPath('coupons', $id), [], $env, $headers);
    }
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::POST, ChargeBee_Util::encodeURIPath('coupons', $id, 'delete'), [], $env, $headers);
    }
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::POST, ChargeBee_Util::encodeURIPath('coupons', $id, 'unarchive'), [], $env, $headers);
    }
}
