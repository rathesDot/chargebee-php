...
class ChargeBee_Addon extends ChargeBee_Model
{
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::GET, ChargeBee_Util::encodeURIPath('addons', $id), [], $env, $headers);
    }

    public static function delete($id, $env = null, $headers = [])
    {
        return ChargeBee_Request::send(ChargeBee_Request::POST, ChargeBee_Util::encodeURIPath('addons', $id, 'delete'), [], $env, $headers);
    }
    ...
    {
        return ChargeBee_Request::send(ChargeBee_Request::POST, ChargeBee_Util::encodeURIPath('addons', $id, 'unarchive'), [], $env, $headers);
    }
}
